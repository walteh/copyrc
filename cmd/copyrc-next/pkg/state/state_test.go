...
// 		// Add file to state
// 		file, err := state.PutRemoteTextFile(ctx, mockFile, dir, PutRemoteTextFileOptions{
// 			IsIgnored: false,
// 		})
...
// 		_, err = state.PutRemoteTextFile(ctx, mockFile, dir, PutRemoteTextFileOptions{
// 			IsIgnored: false,
// 		})
...
// 		file, err := state.PutRemoteTextFile(ctx, mockFile, nonExistentDir, PutRemoteTextFileOptions{
// 			IsIgnored: false,
// 		})
...
// 		_, err = state.PutRemoteTextFile(ctx, mockFile, filePath, PutRemoteTextFileOptions{
// 			IsIgnored: false,
// 		})
