...
func (_m *MockStateManager_state) PutRemoteTextFile(ctx context.Context, file remote.RawTextFile, localPath string) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, remote.RawTextFile, string) (bool, error)); ok {
		return rf(ctx, file, localPath)
	}
	if rf, ok := ret.Get(0).(func(context.Context, remote.RawTextFile, string) bool); ok {
...
func (_c *MockStateManager_state_PutRemoteTextFile_Call) Return(_a0 bool, _a1 error) *MockStateManager_state_PutRemoteTextFile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStateManager_state_PutRemoteTextFile_Call) RunAndReturn(run func(context.Context, remote.RawTextFile, string) (bool, error)) *MockStateManager_state_PutRemoteTextFile_Call {
	_c.Call.Return(run)
	return _c
}
