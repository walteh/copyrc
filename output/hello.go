...
// Greetings is a hello, world program, demonstrating
...
//
//	-g greeting
//		Greet with the given greeting, instead of "Greetings".
//
//	-r
//		Greet in reverse.
//
...
func usage() {
	log.Fprintf(os.Stderr, "usage: hello [options] [name]\n")
	flag.PrintDefaults()
	os.Exit(2)
}

var (
	greeting    = flag.String("g", "Greetings", "Greet with `greeting`")
